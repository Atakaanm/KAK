...
public static class KakUiSetup
{
    ...
    public static string SetupGameUi()
    {
        ...
        Text(ptitle, "DURAKLATILDI", 76, KakPalette.Altin);
        ToggleRow(ppanel, "MusicRow", "Müzik", KakToggle.Setting.Music, -250f);
        ToggleRow(ppanel, "SfxRow", "Efektler", KakToggle.Setting.Sfx, -370f);
        ToggleRow(ppanel, "ShakeRow", "Ekran Sarsıntısı", KakToggle.Setting.ScreenShake, -490f);
        var resume = Button(Place(Rect(ppanel, "ResumeButton"), new Vector2(0.5f, 0f), new Vector2(0f, 470f), new Vector2(620f, 150f)), "DEVAM", Style.Gold, 64, "icon_play.png");
        var restart = Button(Place(Rect(ppanel, "RestartButton"), new Vector2(0.5f, 0f), new Vector2(0f, 300f), new Vector2(620f, 130f)), "YENİDEN BAŞLA", Style.Stone, 52);
        var menu = Button(Place(Rect(ppanel, "MenuButton"), new Vector2(0.5f, 0f), new Vector2(0f, 140f), new Vector2(620f, 130f)), "ANA MENÜ", Style.Stone, 52);
        ...
        Text(title, "OYUN BİTTİ", 84, KakPalette.Tehlike);
        var sl = Place(Rect(gpanel, "ScoreLabel"), new Vector2(0.5f, 1f), new Vector2(0f, -230f), new Vector2(600f, 60f));
        Text(sl, "SKOR", 44, KakPalette.ArduvazAcik, TextAlignmentOptions.Center, false, false);
        ...
        Text(Stretch(Rect(badge, "Label")), "YENİ REKOR!", 50, KakPalette.AltinAcik);
        ...
        var retry = Button(Place(Rect(btns, "RetryButton"), new Vector2(0.5f, 1f), new Vector2(0f, -85f), new Vector2(640f, 160f)), "TEKRAR", Style.Gold, 68, "icon_play.png");
        var toMenu = Button(Place(Rect(btns, "MenuButton"), new Vector2(0.5f, 0f), new Vector2(0f, 70f), new Vector2(640f, 130f)), "ANA MENÜ", Style.Stone, 52);
    ...
    public static string SetupMenu()
    {
        ...
        Text(sub, "SONSUZ TAŞ YAĞMURU", 42, KakPalette.Krem, TextAlignmentOptions.Center);
        ...
        var play = Button(Place(Rect(safe, "PlayButton"), new Vector2(0.5f, 0f), new Vector2(0f, 560f), new Vector2(680f, 200f)), "OYNA", Style.Gold, 96, "icon_play.png");
        var chars = Button(Place(Rect(safe, "CharactersButton"), new Vector2(0.5f, 0f), new Vector2(-175f, 360f), new Vector2(330f, 150f)), "KARAKTER", Style.Stone, 38, "icon_character.png");
        var sett = Button(Place(Rect(safe, "SettingsButton"), new Vector2(0.5f, 0f), new Vector2(175f, 360f), new Vector2(330f, 150f)), "AYARLAR", Style.Stone, 38, "icon_settings.png");
        var levels = Button(Place(Rect(safe, "LevelsButton"), new Vector2(0.5f, 0f), new Vector2(0f, 180f), new Vector2(680f, 130f)), "BÖLÜMLER • YAKINDA", Style.Stone, 40, "icon_lock.png");
        levels.GetComponent<Image>().color = new Color(0.7f, 0.7f, 0.75f, 1f);

        // Ayarlar paneli
        var (sroot, spanel) = Modal(canvas, "SettingsPanel", new Vector2(860f, 1300f));
        Text(Place(Rect(spanel, "Title"), new Vector2(0.5f, 1f), new Vector2(0f, -110f), new Vector2(800f, 120f)), "AYARLAR", 80, KakPalette.Altin);
        ToggleRow(spanel, "MusicRow", "Müzik", KakToggle.Setting.Music, -250f);
        ToggleRow(spanel, "SfxRow", "Efektler", KakToggle.Setting.Sfx, -370f);
        ToggleRow(spanel, "VibrationRow", "Titreşim", KakToggle.Setting.Vibration, -490f);
        ToggleRow(spanel, "ShakeRow", "Ekran Sarsıntısı", KakToggle.Setting.ScreenShake, -610f);
        var reset = Button(Place(Rect(spanel, "ResetButton"), new Vector2(0.5f, 0f), new Vector2(0f, 330f), new Vector2(700f, 120f)), "İLERLEMEYİ SIFIRLA", Style.Stone, 40);
        var closeS = Button(Place(Rect(spanel, "CloseButton"), new Vector2(0.5f, 0f), new Vector2(0f, 150f), new Vector2(620f, 150f)), "KAPAT", Style.Gold, 64);

        // Karakter paneli
        var (croot, cpanel) = Modal(canvas, "CharactersPanel", new Vector2(900f, 1100f));
        Text(Place(Rect(cpanel, "Title"), new Vector2(0.5f, 1f), new Vector2(0f, -110f), new Vector2(800f, 120f)), "KARAKTER", 80, KakPalette.Altin);
        string[] names = { "ALİ", "?", "?" };
        for (int i = 0; i < 3; i++)
        {
            ...
            Text(Place(Rect(card, "Name"), new Vector2(0.5f, 0f), new Vector2(0f, 45f), new Vector2(220f, 60f)),
                 i == 0 ? "SEÇİLİ" : "YAKINDA", 34, i == 0 ? KakPalette.Murekkep : KakPalette.Krem, TextAlignmentOptions.Center, false, i != 0);
        }
        var closeC = Button(Place(Rect(cpanel, "CloseButton"), new Vector2(0.5f, 0f), new Vector2(0f, 140f), new Vector2(620f, 150f)), "KAPAT", Style.Gold, 64);
