...
| Dev/* | `KakDevMenu` | bot, ölümsüzlük, kalkan ver, tüm powerup'lar, `WalkPlayer`, `SetGamesPlayed n`, `SetCoins n`, `PlayAs <id>`, `PlayWithPet <id>`, `PressCharacterCard i`, `PressPetCard i`, `OpenPets`, `OpenDaily <seri>`, `ClaimDaily`, dünya yazısı, UI panelleri |
